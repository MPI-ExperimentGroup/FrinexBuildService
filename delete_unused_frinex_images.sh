...
excludeList=(for warFile in artifacts/*/*_staging_web.war;do unzip -p $warFile version.json | grep projectVersion; done;) | sort | uniq | sed "s/projectVersion:'/-v /g" | sed "s/',//g" | tr '\n' ' '
echo $excludeList
