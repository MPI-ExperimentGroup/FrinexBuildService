...
sed -i "s|swarmNode1Url|node1.example.com|g" /FrinexBuildService/frinex_service_hammer.sh
sed -i "s|swarmNode2Url|node2.example.com|g" /FrinexBuildService/frinex_service_hammer.sh
sed -i "s|swarmNode3Url|node3.example.com|g" /FrinexBuildService/frinex_service_hammer.sh
sed -i "s|nginxProxiedUrl|staging.example.com|g" /FrinexBuildService/frinex_service_hammer.sh
fi
