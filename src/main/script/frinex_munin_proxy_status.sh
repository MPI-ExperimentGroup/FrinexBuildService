...
output_values() {
    ...
    echo "$0, $1, $2, $3, " > $dataDirectory/$1_$2_$3.log
    dockerWebTotal=0;
    dockerAdminTotal=0;
    dockerWebFound=0;
    dockerAdminFound=0;
    ...
    do
        if [[ ${serviceList} != *$runningWar"_staging"* ]]; then
            ...
            if [[ "$headerResult" == *"json"* ]]; then
                ...
                echo "tomcat not found: https://$2/$runningWar/actuator/health" >> $dataDirectory/$1_$2_$3.log
            fi
            tomcatWebTotal=$[$tomcatWebTotal +1]
            tomcatAdminTotal=$[$tomcatAdminTotal +1]
            # echo "" >> $dataDirectory/$1_$2_$3.log
            # echo "https://$2/$runningWar-admin/actuator/health" >> $dataDirectory/$1_$2_$3.log
            # echo "$headerResult" >> $dataDirectory/$1_$2_$3.log
        fi
    done
    echo "tomcatWebTotal.value $tomcatWebTotal"
    echo "tomcatAdminTotal.value $tomcatAdminTotal"
    # echo "tomcatAdminTotal.value $tomcatAdminTotal" >> $dataDirectory/$1_$2_$3.log
    echo "tomcatWebFound.value $tomcatWebFound"
    echo "tomcatAdminFound.value $tomcatAdminFound"
    # echo "tomcatAdminFound.value $tomcatAdminFound" >> $dataDirectory/$1_$2_$3.log
}
