...
# TODO: convert and validate the following build process
exit 0
...
sudo docker run --rm $buildContainerOptions --name $buildContainerName \
            ...
            // + ' ls -l /FrinexBuildService/artifacts/${buildName} &>> /FrinexBuildService/artifacts/${buildName}/${buildName}_staging_admin.txt;'
            ...
            // + ' -Dexperiment.artifactsJsonDirectory=/FrinexBuildService/artifacts/${buildName}/'
