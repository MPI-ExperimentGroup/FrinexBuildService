    ...
    $.getJSON('buildhistory.json?' + new Date().getTime(), function (data) {
        for (var keyString in data.table) {
            ...
            if (!experimentRow) {
                ...
                $.getJSON('https://frinexstaging.mpi.nl/' + keyString + '-admin/health', (function (experimentName, cellStyle) {
                ...
                $.getJSON('https://frinexproduction.mpi.nl/' + keyString + '-admin/health', (function (experimentName, cellStyle) {
                    return function (data) {
                        $.each(data, function (key, val) {
                            if (key === 'status') {
                                if (val === 'UP') {
                ...
                $.getJSON('https://frinexstaging.mpi.nl/' + keyString + '-admin/actuator/health', (function (experimentName, cellStyle) {
                    return function (data) {
                        $.each(data, function (key, val) {
                            if (key === 'status') {
                                if (val === 'UP') {
                ...
                $.getJSON(((typeof data.table[keyString]['_production_target'] !== 'undefined' && data.table[keyString]['_production_target'].value != '') ? data.table[keyString]['_production_target'].value : 'https://frinexproduction.mpi.nl') + '/' + keyString + '-admin/actuator/health', (function (experimentName, cellStyle) {
                    return function (data) {
                        $.each(data, function (key, val) {
                            if (key === 'status') {
                                if (val === 'UP') {
                ...
                $.getJSON('https://frinexstaging.mpi.nl/' + keyString + '/actuator/health', (function (experimentName, cellStyle) {
                    return function (data) {
                        $.each(data, function (key, val) {
                            if (key === 'status') {
                                if (val === 'UP') {
                ...
                $.getJSON(((typeof data.table[keyString]['_production_target'] !== 'undefined' && data.table[keyString]['_production_target'].value != '') ? data.table[keyString]['_production_target'].value : 'https://frinexproduction.mpi.nl') + '/' + keyString + '/actuator/health', (function (experimentName, cellStyle) {
                    return function (data) {
                        $.each(data, function (key, val) {
                            if (key === 'status') {
                                if (val === 'UP') {
