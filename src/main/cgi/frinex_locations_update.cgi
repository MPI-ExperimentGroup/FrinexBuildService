...
comm -2 -3 /usr/local/apache2/htdocs/frinex_all_experiments.txt /usr/local/apache2/htdocs/frinex_runnning_experiments.txt | sed 's/_admin$/-admin/g' > /usr/local/apache2/htdocs/frinex_stopped_experiments.txt
